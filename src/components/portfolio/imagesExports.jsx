...
const deviantartSVG =
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -210 431 690">
...
export {
    ...
    //applications
    gpHero, gpMobile, construction, googleSignIn, addTravelDeal, calender, clock, contactPage, notes, signup, login, travel,
